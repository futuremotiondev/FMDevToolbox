...
FunctionsToExport = 'Add-NumericSuffixToFile', 'Add-StringSuffixToFile', 
               'Confirm-FolderIsGithubRepo', 'Confirm-NPMPackageExistsInRegistry', 
               ...
               'Get-FirstUniqueFileByDepth', 'Get-InstalledPSCoreVersion', 
               'Get-MinicondaInstallDetails', 'Get-ModulePrivateFunctions', 
               'Get-NodeGlobalModules', 'Get-NodeInstalledNPMVersion', 
               'Get-NodeInstalledVersionDetails', 'Get-NodeInstalledVersions', 
               'Get-NumberOfProcessorCoresAndThreads', 
               'Get-NVMNodeInstallationDirectory', 'Get-NVMNodeInstallationExe', 
               'Get-NVMNodeNPMVersions', 'Get-PythonInstallations', 
               ...
               'Move-FontFamiliesToSubfolders', 'Move-VariableFont', 'New-Log', 
               'New-LogSpectre', 'New-TempDirectory', 'Open-FMUserConfigDirectory', 
               'Open-WindowsExplorerTo', 'Out-FileHash', 
               'Read-PressAnyKeyToContinue', 'Register-WindowsDLLorOCX', 
               ...
               'Test-FileIsLocked', 'Test-FunctionAvailability', 'Test-IsAdmin', 
               'Test-IsFontVariable', 'Test-IsValidGUID', 'Test-ModuleIsLoaded', 
               'Test-NodeInstalled', 'Test-NVMForWindowsInstalled', 
